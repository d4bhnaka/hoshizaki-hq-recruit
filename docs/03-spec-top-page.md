...
- **本文導入**：
  > ホシザキを、／フードサービス機器だけのメーカーと思っていないか。／国内のフードサービス機器でトップクラスのシェア。／でも、それだけではない。／世界50ヶ国以上に広がるネットワーク、／海外売上比率50%にも迫るグローバル企業、／食材ロス削減、環境負荷軽減、／そして医療や食品加工といった新分野への挑戦。／常識で思い込みに縛られない。／これからも、ホシザキは進化を止めない。／**さぁ、その想いを翼に変えて。**
